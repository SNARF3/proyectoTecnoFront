            ...
            <v-main>
                <v-container fluid>
                    <v-card class="mb-2" density="compact"
                        ...
                        subtitle="Salsa, merengue, y cumbia" title="Cuba" variant="text" border>
                    ...
                    <v-card density="comfortable" prepend-avatar="https://randomuser.me/api/portraits/women/17.jpg"
                        subtitle="Salsa, merengue, y cumbia" title="Florida" variant="text" border>
